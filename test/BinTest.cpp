...
int main() {
    //int test
    int i1 = 2024, i2;
    BinSerialization::serialize(i1,"n.data");
    BinSerialization::deserialize(i2,"n.data");
    if(i1==i2){
    ...
    BinSerialization::serialize(f1,"n.data");
    BinSerialization::deserialize(f2,"n.data");
    if(f1==f2){
    ...
    //bool test
    bool b1 = false, b2;
    BinSerialization::serialize(b1,"n.data");
    BinSerialization::deserialize(b2,"n.data");
    if(i1==i2){
    ...
    //char test
    char c1 = 'e', c2;
    BinSerialization::serialize(c1,"n.data");
    BinSerialization::deserialize(c2,"n.data");
    if(c1==c2){
    ...
    BinSerialization::serialize(v1_int,"n.data");
    BinSerialization::deserialize(v2_int,"n.data");
    if(v1_int==v2_int){
    ...
    BinSerialization::serialize(v1_float, "n.data");  
    BinSerialization::deserialize(v2_float, "n.data");  
    ...
    BinSerialization::serialize(v1_char, "n.data");  
    BinSerialization::deserialize(v2_char, "n.data");  
    if (v1_char == v2_char) {  
    ...
    BinSerialization::serialize(v1_bool, "n.data");  
    BinSerialization::deserialize(v2_bool, "n.data");  
    if (v1_bool == v2_bool) {  
    ...
    BinSerialization::serialize(s1_int, "n.data");  
    BinSerialization::deserialize(s2_int, "n.data");  
    if (s1_int == s2_int) {  
    ...
    BinSerialization::serialize(s1_float, "n.data");  
    BinSerialization::deserialize(s2_float, "n.data");  
    ...
    BinSerialization::serialize(s1_char, "n.data");  
    BinSerialization::deserialize(s2_char, "n.data");  
    if (s1_char == s2_char) {  
    ...
    BinSerialization::serialize(s1_bool, "n.data");  
    BinSerialization::deserialize(s2_bool, "n.data");  
    if (s1_bool == s2_bool) {  
    ...
    BinSerialization::serialize(l1_int, "n.data");  
    BinSerialization::deserialize(l2_int, "n.data");  
    if (l1_int == l2_int) {  
    ...
    BinSerialization::serialize(l1_float, "n.data");  
    BinSerialization::deserialize(l2_float, "n.data");  
    ...
    BinSerialization::serialize(l1_char, "n.data");  
    BinSerialization::deserialize(l2_char, "n.data");  
    if (l1_char == l2_char) {  
    ...
    BinSerialization::serialize(l1_bool, "n.data");  
    BinSerialization::deserialize(l2_bool, "n.data");  
    if (l1_bool == l2_bool) {  
    ...
    BinSerialization::serialize(p1_int_int, "n.data");  
    BinSerialization::deserialize(p2_int_int, "n.data");  
    ...
    BinSerialization::serialize(p1_int_float, "n.data");  
    BinSerialization::deserialize(p2_int_float, "n.data");  
    ...
    BinSerialization::serialize(p1_int_char, "n.data");  
    BinSerialization::deserialize(p2_int_char, "n.data");  
    ...
    BinSerialization::serialize(p1_int_bool, "n.data");  
    BinSerialization::deserialize(p2_int_bool, "n.data");  
    ...
    BinSerialization::serialize(m1_int_int, "n.data");  
    BinSerialization::deserialize(m2_int_int, "n.data");  
    ...
    BinSerialization::serialize(m1_int_bool, "n.data");  
    BinSerialization::deserialize(m2_int_bool, "n.data");  
    ...
    BinSerialization::serialize(m1_int_char, "n.data");  
    BinSerialization::deserialize(m2_int_char, "n.data");  
    ...
    BinSerialization::serialize(m1_int_float, "n.data");  
    BinSerialization::deserialize(m2_int_float, "n.data");  
    ...
    BinSerialization::serialize(s1, "n.data");  
    BinSerialization::deserialize(s2, "n.data");  
    if (s1 == s2) {  
